...
class ExperienceBuffer(object):
    ...
    def update_buffer(self):
        local_1step_buffer = N_Step_Transition(*zip(*self.local_1step_buffer))
...
#实例化全局缓冲池
global_replay_queue = ReplayMemory(100000)
...
class MultiActor(mp.Process):
    def __init__(self, actor_id, shared_state, actor_params):
        ...
        #self.global_replay_queue_queue = global_replay_queue_queue
